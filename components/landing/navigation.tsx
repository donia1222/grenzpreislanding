      ...
      <nav className="fixed top-0 left-0 right-0 z-50 h-16 bg-background/80 backdrop-blur-xl border-b border-border/50">
        <div className="max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3">
            <img src="/grenzpreis/imageslanding/icon.png" alt="GrenzPreis" className="w-11 h-11 object-contain rounded-[8px]" />
            <div className="flex items-baseline gap-1.5">
              <span className="font-[family-name:var(--font-display)] font-bold text-lg text-foreground">Grenz</span>
              <span className="font-[family-name:var(--font-display)] font-bold text-lg text-primary">Preis</span>
            </div>
          </Link>
      ...
      >
        <div className="flex items-center justify-between px-5 h-16 border-b border-border/50">
          <div className="flex items-center gap-2.5">
            <img src="/grenzpreis/imageslanding/icon.png" alt="GrenzPreis" className="w-9 h-9 object-contain rounded-[8px]" />
            <span className="font-[family-name:var(--font-display)] font-bold text-base text-foreground">
              Grenz<span className="text-primary">Preis</span>
            </span>
          </div>
